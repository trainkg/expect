...
import org.barley.reflection.ReflectionUtils;
...
public class SimpleHibernateDao<T, PK extends Serializable> {
	...
	/**
	 * 按id获取对象. load 应该只是一个代理对象 并没有实际数据 需要使用opensessioninviewfilter 过滤器才能正常工作
	 * 当然是针对页面数据而言
	 * 
	 * 如果是在内存中逻辑运算时候， load不失一个不错的选择。 此处一概而论肯定是不行的。
	 */
	 ...
	 * @return
	 */
	protected T getInternal(final PK id) {
		return null;
	}
	 ...
	 * @param criterions 数量可变的Criterion.
	 */
	public List<T> findOrder(String order, String orderBy, final Criterion... criterions) {
