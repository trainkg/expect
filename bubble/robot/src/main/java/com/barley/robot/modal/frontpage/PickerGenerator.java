 ...
 */
public class PickerGenerator extends AbstractJavaGenerator {

	private final Logger logger = LoggerFactory.getLogger(getClass());
	public static final String PROPERTY_SERVICE_ENABLED = "constants";

	public PickerGenerator(String project) {
		super(project);
	}

	public PickerGenerator(String project, IntrospectedTable introspectedTable) {
		super(project);
