 ...
 * @version $ID: com.barley.system.controller.auth.RoleController create date 2020-12-30 21:58:50
 */
@RestController
@RequestMapping("/role")
public class RoleController {
    ...
    public Resonse create(@ModelAttribute Role record) {
    ...
    public Resonse maintenance(@ModelAttribute Role record) {
        servEntity.update(record);
        return Resonse.newSucessResult("update success");
    }

    @RequestMapping("/query")
    public Resonse query(@ModelAttribute RoleSearchVO searchVO) {
